...
export function Nav({ onHome, badge }: NavProps) {
  return (
    <div style={{ background: '#fff', padding: '14px 20px', display: 'flex', alignItems: 'center', justifyContent: 'space-between', position: 'sticky', top: 0, zIndex: 200, borderBottom: '1px solid #E8E2F0', boxShadow: '0 2px 12px rgba(60,50,100,.06)' }}>
