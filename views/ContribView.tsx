  ...
  return (
    <div>
      ...
      {campaign.card_style === 'casual' ? (
        ...
        <CorporateView campaign={campaign} contributions={previewContribsRich} preview logoScale={campaign.card_logo_scale ?? 1} logoPosition={campaign.card_logo_position ?? 'left'} />
      ) : (
